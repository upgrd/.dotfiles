...
you should place your code here."
  ...
  (defun extsh-cmd-wrapper (cmd)
    "Emulates vim's % reg; expects shell command with %s placeholder as string."
    (interactive)
    (shell-command (format cmd buffer-file-name))
    )

  ;; python-mode key bindung to run python on current buffer
  (evil-define-key 'normal python-mode-map (kbd "<f9>") (lambda () (interactive) (extsh-cmd-wrapper "python3 %s")))
